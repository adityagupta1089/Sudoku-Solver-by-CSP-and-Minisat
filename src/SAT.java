...
public class SAT {
  ...
  private static void diff(int i, int j, int i2, int j2) throws IOException {
    for (int k = 1; k <= 9; k++) {
  ...
  public static void main(String[] args) throws IOException {
    String p = "............8.5.492...6.3.1..9..........21.38...3.......5........6..48..13...96.2";
  ...
  private static int val(int i, int j, int v) {
    int val = 9 * (9 * i + j) + v;
